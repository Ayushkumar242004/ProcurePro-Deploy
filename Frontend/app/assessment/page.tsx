...
export default function AssessmentPage() {
  ...
  const handleAiAnalyzeE = async (factor: string) => {
    ...
    try {
      ...
      const response = await fetch("https://procurepro-x4li.onrender.com/api/gemini-recommendations-eScore", {
        method: "POST",
        headers: {
  ...
  const handleAiAnalyzeS = async (factor: string) => {
    ...
    try {
      ...
      const response = await fetch("https://procurepro-x4li.onrender.com/api/gemini-recommendations-sScore", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleAiAnalyzeG = async (factor: string) => {
    ...
    try {
      ...
      const response = await fetch("https://procurepro-x4li.onrender.com/api/gemini-recommendations-gScore", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleAiAnalyzeC = async (factor: string) => {
    ...
    try {
      ...
      const response = await fetch("https://procurepro-x4li.onrender.com/api/gemini-recommendations-cScore", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleAiAnalyzeRi = async (factor: string) => {
    ...
    try {
      ...
      const response = await fetch("https://procurepro-x4li.onrender.com/api/gemini-recommendations-riScore", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleAiAnalyzeRe = async (factor: string) => {
    ...
    try {
      ...
      const response = await fetch("https://procurepro-x4li.onrender.com/api/gemini-recommendations-reScore", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  useEffect(() => {
    const fetchSuppliers = async () => {
      const res = await fetch("https://procurepro-x4li.onrender.com/api/suppliers");
  ...
  const downloadReport = async (reportId: number) => {
    try {
      ...
      const response = await fetch("https://procurepro-x4li.onrender.com/generate-esg-report", {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
        },
